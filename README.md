...
[![CircleCI](https://circleci.com/gh/react-select/react-select/tree/master.svg?style=shield)](https://circleci.com/gh/react-select/react-select/tree/master)
[![Coverage Status](https://coveralls.io/repos/react-select/react-select/badge.svg?branch=master&service=github)](https://coveralls.io/github/react-select/react-select?branch=master)
...
See [react-select.netlify.app](https://react-select.netlify.app) for live demos and comprehensive docs.
...
- [v1 to v2 upgrade guide](https://react-select.netlify.app/upgrade-guide)
...
See the [props documentation](https://react-select.netlify.app/props) for complete documentation on the props react-select supports.
...
- [Customising the styles](https://react-select.netlify.app/styles)
- [Using custom components](https://react-select.netlify.app/components)
- [Using the built-in animated components](https://react-select.netlify.app/home#animated-components)
- [Creating an async select](https://react-select.netlify.app/async)
- [Allowing users to create new options](https://react-select.netlify.app/creatable)
- [Advanced use-cases](https://react-select.netlify.app/advanced)

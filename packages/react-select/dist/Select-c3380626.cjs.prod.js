...
var _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), _extends = require("@babel/runtime/helpers/extends"), _slicedToArray = require("@babel/runtime/helpers/slicedToArray"), _toConsumableArray = require("@babel/runtime/helpers/toConsumableArray"), index = require("./index-e90bf6a9.cjs.prod.js"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _assertThisInitialized = require("@babel/runtime/helpers/assertThisInitialized"), _inherits = require("@babel/runtime/helpers/inherits"), React = require("react"), memoizeOne = require("memoize-one"), core = require("@emotion/core"), reactDom = require("react-dom"), _css = require("@emotion/css");
...
var colors = {
  ...
  function Select(_props) {
    ...
    _this.commonProps = void 0, _this.hasGroups = !1, _this.initialTouchX = 0, _this.initialTouchY = 0, 
    ...
    _this.userIsDragging = void 0, _this.controlRef = null, _this.getControlRef = function(ref) {
      ...
      }), _this.onMenuClose()), _this.clearFocusValueOnUpdate = !0, _this.onChange(newValue, {
        action: action,
        option: option
      });
    ...
    }, _this.getComponentsFromComponentsProp = memoizeOne__default.default((function(components) {
      return index.defaultComponents({
        components: components
      });
    }), index.exportedEqual), _this.getComponents = function() {
      return _this.getComponentsFromComponentsProp(_this.props.components);
  ...
  return _createClass__default.default(Select, [ {
    ...
    value: function(props, state) {
      var inputIsHiddenAfterUpdate = state.inputIsHiddenAfterUpdate;
      return null != inputIsHiddenAfterUpdate ? {

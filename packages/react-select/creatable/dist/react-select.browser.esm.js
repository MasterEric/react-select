...
import { a as _objectSpread2, _ as _createSuper, D as cleanValue } from '../../dist/index-e5280776.browser.esm.js';
    ...
    _createClass(Creatable, [{
      ...
      value: function getDerivedStateFromProps(props) {
        var allowCreateWhileLoading = props.allowCreateWhileLoading,
            ...
            value = props.value;
        var options = props.options || [];
        var newOption = isValidNewOption(inputValue, cleanValue(value), options) ? getNewOptionData(inputValue, formatCreateLabel(inputValue)) : undefined;
        return {
          newOption: newOption,
